...
public class ShooterSub extends SubsystemBase {
  CANSparkMax upperShooter = new CANSparkMax(Constants.ShooterMech.upperShooterID, MotorType.kBrushless);
  CANSparkMax lowerShooter = new CANSparkMax(Constants.ShooterMech.lowerShooterID, MotorType.kBrushless);
  DigitalInput IntakeLimiterSwitch = new DigitalInput(Constants.ShooterMech.IntakeLimiterSwitch);
