...
public class TeleopSwerveCommand extends Command {
  ...
  public void execute() {
    m_swerveSubSystem.drive(
      Math.pow(-m_LJoystick.getRawAxis(0), 3) * ((-m_RJoystick.getRawAxis(3) + 1) / 2) * Constants.SpeedMultiplier,
      Math.pow(-m_LJoystick.getRawAxis(1), 3) * ((-m_RJoystick.getRawAxis(3) + 1) / 2) * Constants.SpeedMultiplier,
      Math.pow(-m_RJoystick.getRawAxis(0), 3) * ((-m_RJoystick.getRawAxis(3) + 1) / 2) * Constants.TurnMultiplier);
  }
